...
pub const BUTTON_SERVICE_V1: Uuid = Uuid::from_bytes([
    0x88, 0xc3, 0x90, 0x7a, 0xdc, 0x4f, 0x41, 0xb1, 0xbb, 0x04, 0x4e, 0x4d, 0xeb, 0x81, 0xfa, 0xdd,
]);
pub const BUTTON_SERVICE_V2: Uuid = Uuid::from_bytes([
    0x99, 0xc3, 0x15, 0x23, 0xdc, 0x4f, 0x41, 0xb1, 0xbb, 0x04, 0x4e, 0x4d, 0xeb, 0x81, 0xfa, 0xdd,
]);
pub const BUTTON_STATUS_V1: Uuid = Uuid::from_bytes([
    0x47, 0x09, 0x91, 0x64, 0x4d, 0x08, 0x43, 0x38, 0xbe, 0xdf, 0x7f, 0xc0, 0x43, 0xdb, 0xec, 0x5c,
]);
pub const BUTTON_STATUS_V2: Uuid = Uuid::from_bytes([
    0x99, 0xc3, 0x15, 0x25, 0xdc, 0x4f, 0x41, 0xb1, 0xbb, 0x04, 0x4e, 0x4d, 0xeb, 0x81, 0xfa, 0xdd,
]);
